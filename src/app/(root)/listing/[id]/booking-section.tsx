...
function BookingSection({ id, slug, price }: BookingSectionProps) {
  ...
  // use memo is usually used to save values, till the dependencies changed
  // in this case, the dependencies is start and end date
  // the values that we keep from the dependencies in this case, are total days, sub total, tax, etc
  // it will be saved at useMemo
  // the value will change when the dependencies startDate and endDate changed
